    ...
    >
      ...
      >
        ...
        >
          ...
          <P>
            The purpose of this website is to provide a parking system for users
            to find available parking spots and for parking attendants to manage
            and monitor parking spots.
          </P>
          <H2 bold>How do I sign up for an account?</H2>
          <P>
            To sign up for an account, click on the &quote;Sign Up&quote; button
            on the homepage and fill in your details.
          </P>
          ...
          <P>
            You can pay for your parking spot using the payment gateway provided
            on the website.
          </P>
          <H2 bold>How do I cancel my booking?</H2>
          <P>
            To cancel your booking, go to the &quote;My Bookings&quote; section
            of your account and select the booking you wish to cancel.
          </P>
          <H2 bold>What happens if I am late for my booking?</H2>
          <P>
            If you are late for your booking, your parking spot may be given to
            someone else.
          </P>
